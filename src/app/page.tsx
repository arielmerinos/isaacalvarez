  ...
  return (
    <>
      <BackgroundGradientAnimation className="z-10">
        <div className="flex flex-col items-center justify-center h-screen bg-transparent z-10 text-wrap">
          ...
          <h1 className="text-center text-2xl font-bold">Isaac Álvarez Figueroa</h1>
          ...
          <Link
            ...
            className="ml-6 text-white hover:opacity-50"
          >
            <div className="flex cursor-pointer ">
